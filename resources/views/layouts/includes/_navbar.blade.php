...
<nav class="navbar navbar-default navbar-fixed-top">
			<div class="container-fluid">
				...
				<div class="navbar-brand">
					<a href="">Angsuran Perumahan</a>
				</div>
				<!-- end logo -->
				<div class="navbar-right">
					<!-- search form -->
					<form id="navbar-search" class="navbar-form search-form" method="GET" action="/pelanggan">
						<input name="cari" class="form-control" placeholder="Cari di sini" type="search">
						...
						<ul class="nav navbar-nav">
							...
							<li class="dropdown">
								...
								<ul class="dropdown-menu user-menu menu-icon">
									<li class="menu-heading"><p class="text-uppercase">{{auth()->user()->name}}</p></li>
									<li><a href="#"><i class="fa fa-fw fa-edit"></i> <span>Profil</span></a></li>
									...
									<li><a href="/logout"><i class="fa fa-fw fa-paper-plane-o"></i> <span>Keluar</span></a></li>
